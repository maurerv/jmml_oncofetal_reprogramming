...
analysis.dir  <- "/omics/groups/OE0219/internal/jmmlc_pbat_normals/data/odcf_md/analysis/220512_DMR_hierachy_HSC_PanjmmlFetpostnatal"
...
pheno$group   <- paste0(pheno$Sample_Type)
pheno$group[normals] = as.character(pheno$Developmental_Stage[normals])
pheno$group[pheno$group %in% c("perinatal", "juvenile", "young_adult")] = "postnatal"
