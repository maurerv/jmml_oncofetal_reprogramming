...
analysis.dir  <- "/omics/groups/OE0219/internal/jmmlc_pbat_normals/data/odcf_md/analysis/220512_DMR_hierachy_HSC_PrePostneo"
...
groups[groups %in% c("fetal", "perinatal")] = "Preneo"
groups[groups != "Preneo"] = "Postneo"
