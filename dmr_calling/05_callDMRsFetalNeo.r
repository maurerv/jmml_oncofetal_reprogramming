...
analysis.dir  <- "/omics/groups/OE0219/internal/jmmlc_pbat_normals/data/odcf_md/analysis/220512_DMR_hierachy_HSC_FetalNeo"
...
normals   <- normals&(pheno$Developmental_Stage %in% c("fetal","perinatal"))
...
groups[groups == "perinatal"] = "Neo"
groups[groups == "fetal"] = "Fetal"
