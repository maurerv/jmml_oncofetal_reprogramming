...
analysis.dir  <- "/omics/groups/OE0219/internal/jmmlc_pbat_normals/data/odcf_md/analysis/220512_DMR_hierachy_HSC_JuvPostjuv"
...
normals   <- normals & !(pheno$Developmental_Stage %in% c("perinatal", "fetal"))
...
groups[groups %in% c("juvenile")] = "Juv"
