...
analysis.dir  <- "/omics/groups/OE0219/internal/jmmlc_pbat_normals/data/odcf_md/analysis/220512_DMR_hierachy_HSC_FetPostneo"
...
normals   <- normals & !(pheno$Developmental_Stage %in% c("perinatal"))
...
print(groups)
groups[groups %in% c("fetal")] = "Fetal"
groups[groups != "Fetal"] = "Postneo"
